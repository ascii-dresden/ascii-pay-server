...
use crate::model::schema::authentication_nfc_write_key;
use crate::model::{Account, DbConnection, ServiceError, ServiceResult};
...
impl AuthenticationNfc {
    ...
    fn add_write_key(&self, conn: &DbConnection) -> ServiceResult<()> {
        use crate::model::schema::authentication_nfc_write_key::dsl;
...
pub fn remove(conn: &DbConnection, account: &Account) -> ServiceResult<()> {
    use crate::model::schema::authentication_nfc::dsl;
    use crate::model::schema::authentication_nfc_write_key::dsl as dsl2;
